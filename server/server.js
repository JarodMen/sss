...
const db = mysql.createConnection({
  ...
  user: 'darren', // Reemplaza con tu usuario de MySQL
  password: '30401185', // Reemplaza con tu contraseña de MySQL
  database: 'billions' // Reemplaza con el nombre de tu base de datos
});
